...
@property (nonatomic,retain) CoffeeTableViewController *tableViewController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.tableViewController = [[CoffeeTableViewController alloc] init];
    self.navigationController = [[UINavigationController alloc] initWithRootViewController:(UIViewController*)self.tableViewController];
